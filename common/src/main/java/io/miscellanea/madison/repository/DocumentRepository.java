...
public interface DocumentRepository extends AutoCloseable {
   ...
   *
   * @param from The zero-based from which to begin the view. This value is inclusive.
   * @param to The zero-based index at which to end the view. This value is exclusive.
